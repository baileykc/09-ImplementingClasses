...
def run_test_get_distance_from_start():
    print()
    print('-----------------------------------------------------------')
    print('Testing the  get_distance_from_start  method of the Point class.')
    print('-----------------------------------------------------------')
...
def run_test_get_distance_traveled():
    print()
    print('-----------------------------------------------------------')
    print('Testing the  get_distance_traveled  method of the Point class.')
    print('-----------------------------------------------------------')
...
def run_test_closer_to():
    ...
    print()
    print('-----------------------------------------------------------')
    print('Testing the  run_test_closer_to  method of the Point class.')
    print('-----------------------------------------------------------')
...
def run_test_halfway_to():
    print()
    print('-----------------------------------------------------------')
    print('Testing the  run_test_halfway_to  method of the Point class.')
    print('-----------------------------------------------------------')
